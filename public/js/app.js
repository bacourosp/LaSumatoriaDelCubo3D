    ...
    methods: {
        ...
        config: function (e) {
            ...
            if ((!vm.cube.t && !vm.steps) || !vm.cube.n || !vm.cube.m) {
                return alert("Por favor Introduzca los datos correctos!");
            ...
            switch (comandos[0].toUpperCase()) {
                case "UPDATE":
                    ...
                    $.post("/update", {
                        ...
                        vm.comandos.push({text: vm.newCommand, date: new Date(), response: "OK Operacion Exitosa"});
                        vm.newCommand = "";
                        updateActions();
                    }).fail(function (data) {
                        processErrorMessages(data);
                ...
                default:
                    return alert("La Operacion " + vm.newCommand + " no es Correcta");
